...
export const entityConfigs: EntityConfig[] = [
  ...
  },
  {
    path: 'puntos-mapa',
    icon: 'ti-map-pin',
    description: 'Instalaciones señaladas sobre la vista aérea del parque, en El Parque → Mapa.',
    ...
    fields: [
      ...
      { key: 'zona', label: 'Zona (opcional)', type: 'text', placeholder: 'Ej: Zona deportiva' },
      {
        ...
        required: true,
        placeholder: '50',
        hint: 'De 0 a 100, contando desde el borde izquierdo del mapa. 50 es el centro.',
      },
      {
        key: 'y',
        ...
        required: true,
        placeholder: '50',
        hint: 'De 0 a 100, contando desde el borde superior del mapa. 50 es el centro.',
      },
