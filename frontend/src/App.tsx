    ...
    <BrowserRouter>
      <Routes>
        <Route element={<Layout />}>
          ...
          {/* Si hiciera falta volver a ocultar Reserva, la plantilla EnProceso
              (pages/EnProceso.tsx) se pone aquí en su lugar, con el texto y la
              foto de la página. Así estuvo hasta el 17 de septiembre. */}
