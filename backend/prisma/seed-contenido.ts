...
const textos = [
  ...
  { clave: "historia.parrafo", etiqueta: "Historia en un solo texto", grupo: "Historia", valor: "El Parque Central de Santiago abrió sus puertas el 20 de febrero de 2018, tras casi dos décadas de gestiones de la Asociación para el Desarrollo, Inc. (APEDI) junto a instituciones públicas y privadas de la región.

El 6 de abril de ese mismo año quedó formalmente constituido el Patronato para la Administración del Parque Central de Santiago, la entidad sin fines de lucro responsable de su gestión, administración y desarrollo.", multiline: true, orden: 2 },
