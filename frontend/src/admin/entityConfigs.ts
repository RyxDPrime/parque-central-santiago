...
export const entityConfigs: EntityConfig[] = [
  ...
  },
  {
    path: 'metodos-pago',
    icon: 'ti-cash',
    description: 'Las formas de hacer efectivo un aporte. Quien dona elige una, y así el Parque sabe de antemano si le va a llegar una transferencia, alguien a la oficina o un cheque: son tres gestiones distintas.',
    label: 'Formas de aportar',
    titleField: 'nombre',
    fields: [
      { key: 'nombre', label: 'Forma de aportar', type: 'text', required: true, placeholder: 'Ej: Transferencia bancaria', hint: 'Como aparece en el formulario.' },
      { key: 'nota', label: 'Aclaración', type: 'text', placeholder: 'Ej: A las cuentas del Patronato', hint: 'Opcional. Se muestra debajo, en letra pequeña.' },
      { key: 'disponible', label: 'Se puede elegir ya', type: 'checkbox', hint: 'Desmarcado, la opción se ve pero no se puede elegir: aparece anunciada como "próximamente". Es lo que hay que marcar el día que se habilite el pago con tarjeta.' },
      { key: 'activo', label: 'Se muestra en el formulario', type: 'checkbox', hint: 'Desmarcado, desaparece del todo, sin tener que borrarla.' },
      { key: 'orden', label: 'Posición en la lista', type: 'number', placeholder: '1', nextPosition: true },
    ],
  },
  {
  ...
  },
  {
    ...
    titleField: 'nombre',
    fields: [
      { key: 'nombre', label: 'Nombre del espacio', type: 'text', required: true, placeholder: 'Ej: Kiosco grande', hint: 'Como lo va a ver quien solicita.' },
      { key: 'descripcion', label: 'Descripción', type: 'textarea', required: true, placeholder: 'Kiosco techado amplio, para grupos numerosos...', hint: 'Se muestra debajo del selector al elegir este espacio.' },
  ...
  },
  {
    ...
    icon: 'ti-list-check',
    description: 'Para qué se puede pedir un espacio, y para qué no. Esta lista es el filtro del formulario: el tipo de actividad no se escribe, se elige de aquí, así que lo que no esté en la lista no se puede pedir. Las marcadas como no permitidas se publican junto al formulario, para que quien iba a pedir algo que no procede se entere antes.',
    label: 'Tipos de actividad',
    titleField: 'nombre',
    fields: [
      { key: 'nombre', label: 'Tipo de actividad', type: 'text', required: true, placeholder: 'Ej: Cumpleaños o compartir familiar', hint: 'Como aparece en la lista desplegable del formulario.' },
      { key: 'permitido', label: 'Se permite en el Parque', type: 'checkbox', hint: 'Marcado, aparece entre las opciones que se pueden pedir. Desmarcado, aparece en la lista de lo que no se permite.' },
      { key: 'nota', label: 'Aclaración', type: 'text', placeholder: 'Ej: salvo autorización de la Junta', hint: 'Opcional. Se muestra al lado del tipo, en letra pequeña.' },
      { key: 'orden', label: 'Posición en la lista', type: 'number', placeholder: '1', nextPosition: true },
    ],
  },
  {
